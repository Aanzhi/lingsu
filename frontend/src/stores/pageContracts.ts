...
export const PAGE_CONTRACTS: PageContract[] = [
  ...
  { key: 'student.notifications', role: 'student', path: '/student/notifications', title: '工作通知', description: '只显示与你有关且需要处理的项目工作流动态：审核结果、邀请、成员变化和成果状态。' },
  ...
  { key: 'student.announcements', role: 'student', path: '/student/announcements', title: '平台公告', description: '浏览平台发布的公告和学校公开通知；需要处理的个人事项请进入工作通知。' },
  ...
  { key: 'teacher.notifications', role: 'teacher', path: '/teacher/notifications', title: '教师工作通知', description: '只显示与你负责项目有关且需要处理的审核、项目池和成员动态。' },
