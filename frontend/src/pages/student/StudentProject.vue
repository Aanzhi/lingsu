...
const consistencyAICenterLocation = computed(() => ({
  path: '/student/ai',
  query: {
    projectId: String(projectId.value),
    workflow: 'proposal_consistency',
    agent: 'proposal-consistency',
